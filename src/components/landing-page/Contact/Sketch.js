...
export default class App extends Component {
  ...
  setup = (p5, parent) => {
    balls = []
    numberOfCircles = parseInt( (windowHeight > windowWidth ?windowHeight : windowWidth )*0.05); 
    c2 = p5.color('#544d8f');
    c1 = p5.color('#9a80af');
  ...
  circle_MODEL = (p5) =>{
    ...
    let radius = 1; 
    let outerRadius = (windowHeight > windowWidth ?windowHeight : windowWidth )*0.02 ;
